...
*/
void compress_image(vector<vector<uint8_t>> &image, double threshold, int balance, int threads, int verbose = 1)
{
...
{
    Mat image_M;
    image_M = imread("squirrel.jpg", CV_LOAD_IMAGE_GRAYSCALE);
    if (!image_M.data)
    {
